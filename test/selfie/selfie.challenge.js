...
describe('[Challenge] Selfie', function () {
    ...
    it('Execution', async function () {
        ...
        const SelfieAttacker = await ethers.getContractFactory('contracts/player-contracts/SelfieAttacker.sol:SelfieAttacker');

        let iface = new ethers.utils.Interface(['function emergencyExit(address)']);
        ...
        await attacker.attack(TOKENS_IN_POOL, token.address, data);
